...
import com.shuangtu.prison.home.qfragment.Discipline.QFragmentViolationsRoom;
...
//医生预警
public class QFragmentDoctorwarning extends QFragment {
    ...
    public int getLayoutRes() {
        return R.layout.fragment_doctor_warning;
    }
    ...
    public void initView() {
        ...
        PageNumberView viewPageNumber = root.findViewById(R.id.viewPageNumber);
    }
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(final BaseQuickAdapter adapter, View view, final int position) {
                ...
                if (model.isHeader) {
                    ...
                    if(QFragmentDoctorwarning.this.model!=null) {
                        args.putString("id", QFragmentDoctorwarning.this.model.getId());
                    }
                    ...
                    fragmentNoticeList.setOnWebListNoticeListerner(new OnWebListNoticeListerner() {
                        ...
                        public void messageData(QFragmentWeb fragment, String id) {
                            QFragmentDoctorwarning.this.messageWeb(fragment, id);
                        }
                    });
...
//    }
    ...
    public void message(final String msg, int pageSize) {
        ...
        Api.getInstance().newsList(1,10,"doctor-warning")
                .compose(this.<ModelNoticeMessage>bindUntilEvent(FragmentEvent.DESTROY))
                .observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io())
                .subscribe(new Observer<ModelNoticeMessage>() {
