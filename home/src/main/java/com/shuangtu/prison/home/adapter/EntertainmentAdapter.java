...
public class EntertainmentAdapter  extends RecyclerView.Adapter<EntertainmentAdapter.Innholder> {
    ...
    @NonNull
    @Override
    public EntertainmentAdapter.Innholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.entertainment_item, parent, false);
        return new Innholder(mView);
    }

    @Override
    public void onBindViewHolder(@NonNull final EntertainmentAdapter.Innholder holder, final int position) {
...
//                }
    ...
    private EntertainmentAdapter.OnItemClickListenenr getListener;



    public void setOnItemClickListener(EntertainmentAdapter.OnItemClickListenenr listener) {
        this.getListener = listener;
    }
    public class Innholder extends RecyclerView.ViewHolder {

       private  ImageView mImg_select;
        private final ImageView mImg_hook;
